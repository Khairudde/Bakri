...
if not JOINGONKA_KEY:
    raise ValueError("JOINGONKA_API_KEY belum di-set di Environment Variables Railway")
...
# Konfigurasi launch khusus untuk Railway / Server Cloud
